...
-- -- book ticket (seat 10, show 2, customer 1)
-- exec booking_pkg.book_ticket(1, 2, 10);

-- -- make payment (ticket 1, pay 400)
-- exec booking_pkg.make_payment(1, 400);

-- -- cancel ticket (ticket 1)
-- exec booking_pkg.cancel_ticket(1);
